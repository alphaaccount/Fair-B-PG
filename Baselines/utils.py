...
def construct_link_prediction_data_by_node_fairwalk(data_name='movielens', debias_attr=None):
    """Construct dataset for link prediction following fairwalk with walklen=1
    """
    ...
    sensitive_attrs = graph.ndata[debias_attr] if debias_attr else None
