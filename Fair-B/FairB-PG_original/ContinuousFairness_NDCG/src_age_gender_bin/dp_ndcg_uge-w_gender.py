...
def find_dp_ndcg(data, adj_mtx):
    ...
    embedding_np = pk.load(open('../data/pokec-z_gat_entropy_0.01_800_uge-w_gender.bin', 'rb'))
...
def find_dp_ndcg_all(data, adj_mtx):
    ...
    embedding_np = pk.load(open('../data/pokec-z_gat_entropy_0.01_800_uge-w_AGE.bin', 'rb'))
