...
def find_dp_ndcg(data, adj_mtx):
    ...
    n = len(data)
    data1 = np.zeros((m,n))
    embedding_np = pk.load(open('../data/pokec-z_gat_entropy_0.01_800_uge-w_region_fairwalk.bin', 'rb'))
...
def find_dp_ndcg_all(data, adj_mtx):
    ...
    embedding_np = pk.load(open('../data/pokec-z_gat_entropy_0.01_800_uge-w_AGE_fairwalk.bin', 'rb'))
